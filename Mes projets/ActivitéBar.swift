                    ...
                    VStack {
                        ...
                        HStack { // 1er Hstack
                            RoundedRectangle(cornerSize: CGSize(width: 20, height: 10))
                                ...
                                .overlay{ Text("\(barcelone.nombreDePersonnes) personnes") }
                        ...
                        Button (action: {
                            ...
                            Text("Budget activités en \(barcelone.budgetActivitée) €")
